...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.memoryAf xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.memoryAf -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/afonso/vivadoprojects/VesPA-CPU_MEM_italian/aula/aula.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log memoryAf_sc.so .tmp_log xcelium_lib waves.shm c.obj)
