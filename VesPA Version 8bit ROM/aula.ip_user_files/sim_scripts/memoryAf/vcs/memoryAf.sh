...
#                script (type 'memoryAf.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.memoryAf xil_defaultlib.glbl -o memoryAf_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./memoryAf_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/afonso/vivadoprojects/VesPA-CPU_MEM_italian/aula/aula.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key memoryAf_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc memoryAf_simv.daidir vcs_lib c.obj)
