...
#
# Script generated by Vivado on Sun Nov 19 21:43:35 WET 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : memoryAf.sh
...
#
# Usage        : memoryAf.sh
#                memoryAf.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                memoryAf.sh [-reset_run]
#                memoryAf.sh [-reset_log]
#                memoryAf.sh [-help]
#
...
# script info
echo -e "memoryAf.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./memoryAf.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot memoryAf xil_defaultlib.memoryAf xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim memoryAf -key {Behavioral:sim_1:Functional:memoryAf} -tclbatch cmd.tcl -protoinst "protoinst_files/memoryAf.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb memoryAf.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./memoryAf.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: memoryAf.sh [-help]\n\
Usage: memoryAf.sh [-step]\n\
Usage: memoryAf.sh [-lib_map_path]\n\
Usage: memoryAf.sh [-reset_run]\n\
Usage: memoryAf.sh [-reset_log]\n\
Usage: memoryAf.sh [-keep_index]\n\
Usage: memoryAf.sh [-noclean_files]\n\n\
